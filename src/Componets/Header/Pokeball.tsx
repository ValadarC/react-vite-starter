 const PokeballLogo = () => {
  return (
    ...
    >
      <g clip-path="url(#clip0_2069_658)">
        <path
        ...
        />
        <path
          d="M16.5 22C16.5 23.4587 17.0795 24.8576 18.1109 25.8891C19.1424 26.9205 20.5413 27.5 22 27.5C23.4587 27.5 24.8576 26.9205 25.8891 25.8891C26.9205 24.8576 27.5 23.4587 27.5 22C27.5 20.5413 26.9205 19.1424 25.8891 18.1109C24.8576 17.0795 23.4587 16.5 22 16.5C20.5413 16.5 19.1424 17.0795 18.1109 18.1109C17.0795 19.1424 16.5 20.5413 16.5 22Z"
          stroke="#030303"
          stroke-width="2.75"
          stroke-linecap="round"
          stroke-linejoin="round"
